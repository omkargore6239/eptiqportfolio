...
function HeroPage() {
  ...
  return (
    <section className="relative bg-gradient-to-r from-blue-500 to-white text-white w-full min-h-screen flex flex-col md:flex-row items-center justify-center py-12 px-6 md:px-12 mt-16 sm:mt-0">
      <div className="text-center md:text-left md:w-1/2 space-y-6 md:space-y-8">
        ...
        <div className="flex flex-wrap gap-4 text-lg md:text-xl font-medium text-white">
          <div className="flex items-center gap-2 bg-white bg-opacity-20 p-3 rounded-lg shadow-md">
            <FaLaptopCode className="text-yellow-400 text-3xl" /> Empowering Brands with Cutting-Edge Tools
          </div>
          <div className="flex items-center gap-2 bg-white bg-opacity-20 p-3 rounded-lg shadow-md">
            <FaMobileAlt className="text-yellow-400 text-3xl" /> Mobile App Development
          </div>
          <div className="flex items-center gap-2 bg-white bg-opacity-20 p-3 rounded-lg shadow-md">
            <FaCloud className="text-yellow-400 text-3xl" /> Cloud Solution
          </div>
        </div>
      ...
      <div className="slider-container mt-10 md:mt-0 md:w-1/2 w-full">
        <Slider {...settings}>
          <div>
            <img
              src="/src/assets/office/office1.png"
              alt="Office 1"
          ...
          <div>
            <img
              src="/src/assets/office/office 2.png"
              alt="Office 2"
              className="w-full h-[60vh] md:h-auto object-contain rounded-lg "
            />
          </div>
          <div>
            <img
              src="/src/assets/office/office 3.png"
              alt="Office 3"
              className="w-full h-[60vh] md:h-auto object-contain rounded-lg"
            />
          </div>
