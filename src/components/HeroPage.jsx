...
function HeroPage() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white w-full min-h-screen flex flex-col md:flex-row items-center justify-center py-12 px-6 md:px-12 mt-10 sm:mt-0">
      {/* Text Content */}
